...
- [`register_study()`](register_study.md) :

  Register a NEW project for the NF Data Portal in **Portal - Project
  View**

- [`add_people_from_table()`](add_people_from_table.md) : Update the
  People table from a source Table or View column

- [`register_study_files()`](register_study_files.md) :
...
- [`new_project()`](new_project.md) : Create a new project
